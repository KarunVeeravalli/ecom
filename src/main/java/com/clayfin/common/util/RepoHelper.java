...
public class RepoHelper {
	...
	public String getOtpAndMsg(String otp) {
		...
		String body = "Dear Customer,\n"
				...
				+ "\n"
				+ "\n"
				+" "   + otp+" is your SECRET OTP for Accessing our E-com Application at Browser on "+ LocalDate.now() +",  OTP valid for 5 mins.Pls do not share OTP with anyone.\n"
				+ "\n"
				+ "\n"
				+"\n"
...
public String getLoginMsg(String mail)  {
		...
		String body = "Dear Customer,\n"
				...
				+ "\n"
				+ "\n"+
				    "http://localhost:8080/ to change password"
